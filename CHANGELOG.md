...
- f66496a: Add keyboard shortcuts for mode switching and drawing actions.
...
- 75a40a8: chore: upgrade terra-draw to v1.32.2
- 63e8eb4: chore: support maplibre-gl v6

## 1.15.0

### Minor Changes

- c8777b4: feat: split Valhalla logic into dedicated modes and store isochrone results as polygons directly in Terra Draw
...
- 649dd18: feat: support TerraDrawPolyLineMode for MaplibreTerradrawControl and MaplibreMeasureControl. In MaplibreMeasureControl, it starts working as line measurement, when users close line to make a polygon, it converts line measurement to area measurement.
- 1c4026d: Added `TerraDrawTextMode` — a custom Terra Draw mode that lets users place, edit, and drag freeform text labels anywhere on the map.
...
- 8d10974: chore: upgrade Terra Draw to v1.31.2
...
- 8c2c795: feat: add undo/redo mode to MaplibreTerradrawControl and MaplibreMeasureControl
...
- acd0503: chore: upgrade terradraw to 1.27.0

## 1.12.2

### Patch Changes

- 124e886: chore: upgrade Terra Draw to v1.25.0
...
- 59c671c: feat: split valhalla isochrone button into two buttons for time isochrone and distance isochrone.
...
- 2c55078: chore: upgrade TerraDraw to v1.24.2
...
- 5b0dd14: feat: custom callback can be passed for distanceUnit and areaUnit properties of MaplibreMeasureControl.
...
- 916fa14: chore: upgrade TerraDraw from v1.21.0 to v1.23.1.
...
- 7b69519: chore: upgraded all other dependencies of documentation including vitest to v4.
- 7b69519: fix: refine the default parameters of circle and rectangle of TerraDrawSelectMode.
...
- 7b69519: chore: upgrade terra-draw to v1.18.1

## 1.9.2

### Patch Changes

- 42f5583: fix: directly update properties in MeasureControl
